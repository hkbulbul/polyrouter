...
Hướng dẫn cài đặt chi tiết cho PolyRouter với mẹo troubleshooting.
...
Cài PolyRouter toàn cục để dùng ở bất kỳ đâu:

```bash
npm install -g polyrouter
```

**Khởi động PolyRouter:**
...
**Lợi ích:**
- ✅ Chạy từ mọi thư mục
- ✅ Lệnh đơn giản: `polyrouter`
- ✅ Auto-update với `npm update -g polyrouter`
...
3. Data directory được tạo tại `~/.polyrouter`
...
**Vấn đề:** PolyRouter dùng quá nhiều RAM
...
# Delete polyrouter-related exports
```
