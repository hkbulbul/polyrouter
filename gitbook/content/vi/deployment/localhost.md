...
Chạy PolyRouter trên máy cá nhân để phát triển và dùng cá nhân.

---

## 📦 Cài đặt

Cài đặt PolyRouter toàn cục qua npm:
...
Khởi động PolyRouter với một lệnh duy nhất:
...
Nhấn `Ctrl+C` trong terminal đang chạy PolyRouter.
