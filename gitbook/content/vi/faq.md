...
Những câu hỏi phổ biến về PolyRouter.

---

## PolyRouter là gì?

**PolyRouter là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**PolyRouter dùng chiến lược pricing 3 tầng:**
...
## PolyRouter có miễn phí không?

**Có, PolyRouter hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của PolyRouter.**
...
**PolyRouter theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host PolyRouter không?

**Có! PolyRouter hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.polyrouter`)
...
**Có, PolyRouter ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.polyrouter` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server PolyRouter
...
## Làm thế nào để cập nhật PolyRouter?
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/hkbulbul/polyrouter/blob/main/CHANGELOG.md)
- Backup `~/.polyrouter` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/hkbulbul/polyrouter/blob/main/CONTRIBUTING.md) để biết chi tiết.

---

## Cần trợ giúp thêm?

- **Documentation:** [useusepolyrouter.com/docs](https://useusepolyrouter.com/docs)
