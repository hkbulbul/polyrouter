...
Tích hợp PolyRouter với OpenAI Codex CLI để định tuyến request API OpenAI qua hệ thống routing thông minh của PolyRouter.
...
PolyRouter cung cấp các model Codex sau:
...
1. Xác minh API key đúng trong PolyRouter dashboard
...
1. Xác minh tên model khớp với cấu hình PolyRouter
2. Kiểm tra kết nối provider OpenAI đang hoạt động trong PolyRouter dashboard
...
Đảm bảo bạn đã cấu hình API key trong PolyRouter cloud dashboard.
