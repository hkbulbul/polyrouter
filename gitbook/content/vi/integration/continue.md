...
Tích hợp PolyRouter với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- PolyRouter API key từ [dashboard](https://useusepolyrouter.com/dashboard)
- PolyRouter đang chạy (cục bộ hoặc cloud)
...
### 2. Thêm Cấu hình Model PolyRouter
...
3. Chọn model PolyRouter ưa thích
...
- Kiểm tra PolyRouter đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến PolyRouter
