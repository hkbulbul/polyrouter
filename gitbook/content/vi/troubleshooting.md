...
Các vấn đề và giải pháp phổ biến khi dùng PolyRouter.
...
1. **Auto-refresh (mặc định):**
   PolyRouter tự refresh tokens. Đợi 30 giây rồi thử lại.
...
**Nguyên nhân:**
- PolyRouter không chạy
- Port 20128 bị chặn
- Firewall chặn kết nối

**Giải pháp:**

1. **Khởi động PolyRouter:**
   ```bash
   polyrouter
   ```
...
1. **Kiểm tra PolyRouter có chạy không:**
   ```bash
   # Check process
