...
PolyRouterをClaude Code CLIと統合し、AnthropicのAPIリクエストをPolyRouterのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはPolyRouterモデルにマッピングされる以下のモデルエイリアスをサポート:
...
1. モデル名がPolyRouterの設定と一致しているか確認
