...
トラブルシューティングのヒント付きのPolyRouter詳細インストールガイド。
...
どこからでも使用できるようにPolyRouterをグローバルインストール:
...
**利点:**
- ✅ どのディレクトリからでも実行
- ✅ シンプルなコマンド: `polyrouter`
- ✅ `npm update -g polyrouter` で自動更新
