...
開発と個人利用のため、ローカルマシンでPolyRouterを実行。

---

## 📦 インストール

npm経由でPolyRouterをグローバルインストール:
...
PolyRouterが実行されているターミナルで `Ctrl+C` を押します。

```bash
# polyrouterを実行しているターミナル
^C  # Ctrl+Cを押す
```
