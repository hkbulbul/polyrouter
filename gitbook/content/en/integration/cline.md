...
Integrate PolyRouter with Cline VSCode extension to route your AI requests through PolyRouter's intelligent routing system.

## Prerequisites

- Visual Studio Code installed
- Cline extension installed from VSCode marketplace
- PolyRouter running locally or cloud endpoint configured
...
Set the base URL to your PolyRouter endpoint:

**For Local PolyRouter:**
```
http://localhost:20128/v1
```

**For Cloud PolyRouter:**
```
https://useusepolyrouter.com
```

**Steps:**
1. In the **Base URL** field, enter your PolyRouter endpoint
...
3. The key should start with `sk-polyrouter-`

### 5. Select Model

1. In the **Model** dropdown, you can either:
   - Select from available models (if Cline auto-detects them)
   - Manually enter the model name from your PolyRouter configuration
...
4. Cline will use PolyRouter to process your request

### Code Generation

1. Ask Cline to generate code: "Create a React component for a login form"
2. Cline will generate code using PolyRouter
...
3. Get AI-powered explanations through PolyRouter

### File Operations

1. Ask Cline to create, modify, or delete files
2. Cline will use PolyRouter to understand context and make changes
...
1. Verify PolyRouter is running: `curl http://localhost:20128/health`
...
2. Verify your PolyRouter instance is running and healthy
3. Try reloading VSCode window (Cmd/Ctrl + Shift + P → "Reload Window")
4. Check PolyRouter logs for any errors

## Advanced Configuration

### Using Cloud Endpoint

To use PolyRouter cloud endpoint instead of localhost:

1. In Cline settings, set Base URL to: `https://useusepolyrouter.com`
2. Make sure you have configured your API key in the PolyRouter cloud dashboard
...
## Integration with PolyRouter Features

### Model Routing

PolyRouter automatically routes your requests to the best available provider based on:
- Model availability
...
If a provider fails, PolyRouter automatically falls back to alternative providers configured in your dashboard.

### Usage Tracking

Monitor your Cline usage through PolyRouter dashboard:
- Total requests
- Token usage
- Cost per model
