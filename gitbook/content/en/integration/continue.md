...
Integrate PolyRouter with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- PolyRouter API key from [dashboard](https://useusepolyrouter.com/dashboard)
- PolyRouter running (local or cloud)
...
### 2. Add PolyRouter Model Configuration
...
3. Choose your preferred PolyRouter model
...
- Check network latency to PolyRouter
