...
Integrate PolyRouter with OpenAI Codex CLI to route your OpenAI API requests through PolyRouter's intelligent routing system.
...
PolyRouter provides the following Codex models:
...
1. Verify your API key is correct in PolyRouter dashboard
...
1. Verify the model name matches your PolyRouter configuration
2. Check that the OpenAI provider connection is active in PolyRouter dashboard
...
Make sure you have configured your API key in the PolyRouter cloud dashboard.
