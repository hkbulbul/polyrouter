...
PolyRouter is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

PolyRouter provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to PolyRouter using these settings:

**Local PolyRouter:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any PolyRouter model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to PolyRouter
```bash
...
- Check network connection to PolyRouter
