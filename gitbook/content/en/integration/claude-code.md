...
Integrate PolyRouter with Claude Code CLI to route your Anthropic API requests through PolyRouter's intelligent routing system.
...
Claude Code supports the following model aliases that map to PolyRouter models:
