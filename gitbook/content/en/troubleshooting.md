...
Common issues and solutions when using PolyRouter.
...
1. **Auto-refresh (default):**
   PolyRouter automatically refreshes tokens. Wait 30 seconds and retry.
...
1. **Check if PolyRouter is running:**
   ```bash
   # Check process
