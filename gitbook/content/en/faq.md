...
Common questions about PolyRouter.

---

## What is PolyRouter?

**PolyRouter is an AI model router that maximizes your subscription value and minimizes costs.**
...
**PolyRouter uses a 3-tier pricing strategy:**
...
**Yes! This is PolyRouter's core feature.**
...
**PolyRouter tracks quota in real-time for all providers:**
...
## Can I self-host PolyRouter?

**Yes! PolyRouter supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.polyrouter`)
...
**Yes, PolyRouter prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.polyrouter` (or custom `DATA_DIR`)
- No data sent to PolyRouter servers
...
**What PolyRouter stores:**
- Provider OAuth tokens (encrypted)
- API keys (encrypted)
- Usage statistics (local only)
- Combo configurations

**What PolyRouter does NOT store:**
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/hkbulbul/polyrouter/blob/main/CHANGELOG.md)
- Backup `~/.polyrouter` before major updates
...
See [CONTRIBUTING.md](https://github.com/hkbulbul/polyrouter/blob/main/CONTRIBUTING.md) for details.
