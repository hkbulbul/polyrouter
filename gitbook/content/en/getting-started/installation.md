...
Detailed installation guide for PolyRouter with troubleshooting tips.
...
Install PolyRouter globally to use from anywhere:
...
- ✅ Simple command: `polyrouter`
- ✅ Auto-updates with `npm update -g polyrouter`
...
3. Data directory created at `~/.polyrouter`
...
**Issue:** PolyRouter using too much RAM
