...
Problemas comunes y soluciones al usar PolyRouter.
...
1. **Refresh automático (por defecto):**
   PolyRouter refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
**Causas:**
- PolyRouter no está ejecutándose
...
4. **Usa el endpoint en la nube:**
   ...
   ```
   Endpoint: https://useusepolyrouter.com/v1
   ```
...
1. **Verifica si PolyRouter está ejecutándose:**
   ```bash
   # Verifica el proceso
   ps aux | grep polyrouter
...
- **GitHub Issues:** [github.com/hkbulbul/polyrouter/issues](https://github.com/hkbulbul/polyrouter/issues)
