...
Integra PolyRouter con OpenAI Codex CLI para enrutar tus solicitudes de la API de OpenAI a través del sistema de enrutamiento inteligente de PolyRouter.
...
PolyRouter proporciona los siguientes modelos de Codex:
...
```json
{
  ...
  "apiKey": "your-polyrouter-api-key",
...
1. Verifica que tu API key sea correcta en el dashboard de PolyRouter
...
1. Verifica que el nombre del modelo coincida con tu configuración de PolyRouter
2. Verifica que la conexión del proveedor de OpenAI esté activa en el dashboard de PolyRouter
...
```bash
export OPENAI_BASE_URL="https://useusepolyrouter.com"
```

Asegúrate de haber configurado tu API key en el dashboard en la nube de PolyRouter.
