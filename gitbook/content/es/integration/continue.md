...
Integra PolyRouter con la extensión Continue para llevar la asistencia de IA directamente a Visual Studio Code.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Continue instalada desde el marketplace de VSCode
- API key de PolyRouter desde el [dashboard](https://useusepolyrouter.com/dashboard)
- PolyRouter ejecutándose (local o en la nube)
...
### 2. Agregar configuración de modelo de PolyRouter
...
```json
{
  "models": [
    {
      "title": "PolyRouter - Claude Opus (Best)",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key-from-dashboard",
      "apiBase": "http://localhost:20128/v1"
    ...
    {
      "title": "PolyRouter - Claude Sonnet (Balanced)",
      "provider": "openai",
    ...
    {
      "title": "PolyRouter - DeepSeek Chat (Code)",
      "provider": "openai",
    ...
    {
      "title": "PolyRouter - Claude Haiku (Fast)",
      "provider": "openai",
...
```json
"apiBase": "https://useusepolyrouter.com/v1"
```
...
3. Elige tu modelo preferido de PolyRouter
...
```json
{
  "models": [
    {
      "title": "PolyRouter - Creative Writer",
      "provider": "openai",
      "model": "cc/claude-opus-4-5-20251101",
      "apiKey": "your-api-key",
      "apiBase": "http://localhost:20128/v1",
...
- Verifica que PolyRouter esté corriendo: `curl http://localhost:20128/health`
...
- Selecciona el modelo correcto de PolyRouter
...
- Verifica la latencia de red hacia PolyRouter
