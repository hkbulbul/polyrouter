...
PolyRouter es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

PolyRouter proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a PolyRouter usando estas configuraciones:

**PolyRouter local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de PolyRouter (cc/*, cx/*, glm/*, etc.)
```

**PolyRouter en la nube:**
```
Base URL: https://useusepolyrouter.com/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de PolyRouter (cc/*, cx/*, glm/*, etc.)
```
...
**Problema:** No se puede conectar a PolyRouter
```bash
# Verifica si PolyRouter está corriendo
...
**Solución:**
- Verifica que PolyRouter esté corriendo
...
- Verifica la conexión de red a PolyRouter
