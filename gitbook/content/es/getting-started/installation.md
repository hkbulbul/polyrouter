...
Guía detallada de instalación de PolyRouter con consejos de solución de problemas.
...
Instala PolyRouter globalmente para usar desde cualquier lugar:
...
- ✅ Comando simple: `polyrouter`
- ✅ Auto-actualizaciones con `npm update -g polyrouter`
...
3. Se crea el directorio de datos en `~/.polyrouter`
...
**Ubicación por defecto:** `~/.polyrouter`
...
**Error:**
```
Error: EACCES: permission denied, mkdir '/usr/local/lib/node_modules/polyrouter'
```
...
**Problema:** PolyRouter usa demasiada RAM
...
```bash
npm install -g pm2
pm2 start polyrouter --name polyrouter
pm2 save
```
...
```bash
docker pull polyrouter/polyrouter:latest

docker run -d \
  -p 20128:20128 \
  -e JWT_SECRET="your-secure-secret" \
  -e INITIAL_PASSWORD="your-password" \
  -v polyrouter-data:/root/.polyrouter \
  --name polyrouter \
  polyrouter/polyrouter:latest
```
...
nano ~/.bashrc  # o ~/.zshrc
# Eliminar exports relacionados con polyrouter
```
...
- **Sitio web**: [useusepolyrouter.com](https://useusepolyrouter.com)
