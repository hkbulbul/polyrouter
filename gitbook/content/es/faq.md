...
Preguntas comunes sobre PolyRouter.

---

## ¿Qué es PolyRouter?

**PolyRouter es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**PolyRouter usa una estrategia de precios de 3 niveles:**
...
**¡Sí! Esta es la característica principal de PolyRouter.**
...
**PolyRouter rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿PolyRouter funciona con Cursor?

**Sí, pero Cursor requiere un endpoint en la nube.**

**Problema:** Cursor IDE no soporta endpoints en localhost.

**Solución:** Usa el despliegue en la nube de PolyRouter:

```
Cursor Settings → Models → Advanced:
  OpenAI API Base URL: https://useusepolyrouter.com/v1
...
## ¿Puedo auto-hospedar PolyRouter?

**¡Sí! PolyRouter soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.polyrouter`)
...
**Sí, PolyRouter prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.polyrouter` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de PolyRouter
...
**Cambios disruptivos:**
- Revisa [CHANGELOG.md](https://github.com/hkbulbul/polyrouter/blob/main/CHANGELOG.md)
- Respalda `~/.polyrouter` antes de actualizaciones mayores
...
1. **Reportar bugs:**
   - [GitHub Issues](https://github.com/hkbulbul/polyrouter/issues)
   - Incluye logs de error, pasos para reproducir

2. **Solicitar características:**
   - [GitHub Discussions](https://github.com/hkbulbul/polyrouter/discussions)
   - Describe el caso de uso y los beneficios

3. **Enviar código:**
   ```bash
   # Fork del repo
   git clone https://github.com/YOUR_USERNAME/polyrouter.git
   cd polyrouter
...
Consulta [CONTRIBUTING.md](https://github.com/hkbulbul/polyrouter/blob/main/CONTRIBUTING.md) para detalles.

---

## ¿Necesitas más ayuda?

- **Documentación:** [useusepolyrouter.com/docs](https://useusepolyrouter.com/docs)
