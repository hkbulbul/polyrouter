...
export default {
  ...
  models: [
    { id: "gemini-3.8-flash-tiered", name: "Gemini 3.8 Flash" },
    ...
    { id: "gemini-3.6-flash-tiered", name: "Gemini 3.6 Flash" },
    { id: "gemini-3.6-flash", name: "Gemini 3.6 Flash", upstreamModelId: "gemini-3.6-flash-tiered" },
