export default {
  ...
  models: [
    ...
    { id: "gpt-realtime-2", name: "GPT Realtime 2", kind: "speechToSpeech" },
    { id: "gpt-realtime", name: "GPT Realtime", kind: "speechToSpeech" },
    { id: "gpt-realtime-mini", name: "GPT Realtime Mini", kind: "speechToSpeech" },
  ...
  serviceKinds: ["llm","embedding","tts","stt","speechToSpeech","image","imageToText","webSearch"],
  ttsConfig: {
