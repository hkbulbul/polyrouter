 ...
 * CLIProxyAPIPlus reference implementation, scoped down to what polyrouter needs:
 *
 ...
 *
 * Kiro upstream does not advertise `-agentic` model IDs; they are a polyrouter
...
/**
 * Detect whether a model id refers to a polyrouter synthetic agentic variant.
...
/**
 * Detect whether a model id is a polyrouter synthetic thinking variant
...
/**
 * Resolve a polyrouter model id to the real upstream Kiro model id, plus flags
