 ...
 * into polyrouter-shaped variants:
 *
 *   {upstream}                          - base model
 ...
 * API. They are polyrouter fictions and the `openai-to-kiro` translator strips
...
/**
 * Build the synthetic polyrouter variant set for a single upstream Kiro model.
 *
 ...
 * into polyrouter variants (`-thinking`, `-agentic`, `-thinking-agentic`).
 *
