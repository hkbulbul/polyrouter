        ...
        {sttModels.length > 0 ? (
          ...
          <Row label="Model">
            <input
              ...
              className="w-full px-3 py-1.5 text-sm border border-border  bg-background focus:outline-none focus:border-primary font-mono"
            />
          </Row>
        )}
        ...
        <Row label="Audio File">
          <div className="flex flex-col gap-2">
            <input
              ...
              className="w-full text-xs text-text-muted file:mr-2 file:py-1 file:px-2.5 file: file:border file:border-border file:bg-background file:text-text-main hover:file:bg-sidebar file:cursor-pointer"
            />
            {audioFile && (
