...
function CompatibleModelRow({ modelId, fullModel, copied, onCopy, onDeleteAlias, onTest, testStatus, isTesting }) {
  ...
  return (
    <div className={`flex items-center gap-3 p-3  border ${borderColor} hover:bg-sidebar/50`}>
      <span
        ...
        <div className="flex items-center gap-1 mt-1">
          ...
          <div className="relative group/btn">
            <button
              ...
              className="p-0.5 hover:bg-sidebar  text-text-muted hover:text-primary"
            >
          ...
          {onTest && (
            <div className="relative group/btn">
              <button
                onClick={onTest}
                disabled={isTesting}
                className="p-0.5 hover:bg-sidebar  text-text-muted hover:text-primary transition-colors"
              >
