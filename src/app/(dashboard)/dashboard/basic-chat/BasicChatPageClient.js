  ...
  return (
    <div className="relative flex-1 flex flex-col h-full min-h-0 min-w-0 bg-[#212121] text-white overflow-hidden">
      <div className="relative mx-auto flex flex-1 h-full min-h-0 w-full max-w-4xl flex-col">
        <div className="flex shrink-0 items-center justify-between gap-3 px-4 py-3 lg:px-6">
          <div ref={modelMenuRef} className="relative">
            <button
              ...
              className="flex items-center gap-3  border border-white/10 bg-white/5 px-4 py-3 text-left transition hover:bg-white/8"
            >
            ...
            {modelMenuOpen ? (
              <div className="absolute left-0 top-[calc(100%+10px)] z-30 w-[min(520px,calc(100vw-2rem))] overflow-hidden  border border-white/10 bg-[#262626] shadow-2xl shadow-black/50">
                ...
                <div className="max-h-[60vh] overflow-y-auto p-2 custom-scrollbar">
                  {providerGroups.map((group) => (
                    <div key={group.providerId} className="mb-2  border border-white/10 bg-black/20 p-2">
                        ...
                        {group.models.map((model) => {
                          ...
                          return (
                            <button
                              ...
                              className={` border px-3 py-3 text-left transition ${isActive ? "border-blue-400/40 bg-blue-500/15" : "border-white/10 bg-white/5 hover:bg-white/8"}`}
                            >
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className=" border border-white/10 bg-white/5 px-4 py-3 text-sm text-white/80 transition hover:bg-white/8"
            >
              History
            </button>
        ...
        {historyOpen ? (
          <div ref={historyMenuRef} className="absolute right-4 top-[72px] z-20 w-[min(360px,calc(100vw-2rem))]  border border-white/10 bg-[#262626] p-2 shadow-2xl shadow-black/50 lg:right-6">
            ...
            <div className="max-h-[48vh] space-y-2 overflow-y-auto p-1 custom-scrollbar">
              {sessionItems.length === 0 ? (
                <div className=" border border-dashed border-white/10 bg-white/5 p-4 text-sm text-white/55">
                ...
                return (
                  <button
                    ...
                    className={`w-full  border px-3 py-3 text-left transition ${isActive ? "border-blue-400/40 bg-blue-500/15" : "border-white/10 bg-white/5 hover:bg-white/8"}`}
                  >
                    <div className="flex items-start justify-between gap-3">
        ...
        {loadError ? (
          <div className="mt-4  border border-rose-500/20 bg-rose-500/10 px-4 py-3 text-rose-100">
        ...
        <div className="flex flex-1 flex-col min-h-0">
            ...
            {currentMessages.length === 0 ? (
              <div className="flex min-h-[50vh] items-center justify-center px-4 text-center">
                <div className="max-w-xl space-y-4">
                  <div className="mx-auto flex size-16 items-center justify-center  border border-white/10 bg-white/5 text-white/80">
                      ...
                      {message.attachments?.length ? (
                        <div className="mb-3 grid grid-cols-2 gap-2 sm:grid-cols-3 mt-2">
                          {message.attachments.map((attachment) => (
                            <a key={attachment.id} href={attachment.dataUrl} target="_blank" rel="noreferrer" className="overflow-hidden  border border-white/10 bg-black/20">
          ...
          <div className="shrink-0 pt-2">
            ...
            <div className="mx-auto w-full max-w-3xl px-4 pb-2">
              <div className=" bg-[#2f2f2f] px-3 pt-3 pb-2 shadow-[0_0_15px_rgba(0,0,0,0.10)] ring-1 ring-white/5">
                <textarea
                  value={draft}
