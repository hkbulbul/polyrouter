...
const STORAGE_KEY = "polyrouter.cliToolEndpointPresets";
    ...
    <div className="flex flex-col gap-1.5">
      <div className="flex items-center gap-2">
        <select
          ...
          className="flex-1 min-w-0 px-2 py-2 bg-surface  text-xs border border-border focus:outline-none focus:ring-1 focus:ring-primary/50 sm:py-1.5"
        >
          {options.map((o) => (
        ...
        {isSaved && (
          <button type="button" onClick={handleDeleteSaved} className="p-1 text-text-muted hover:text-red-500  transition-colors shrink-0" title="Delete saved endpoint">
