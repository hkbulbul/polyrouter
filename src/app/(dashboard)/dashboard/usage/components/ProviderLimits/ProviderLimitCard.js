    ...
    <Card padding="md" className="flex flex-col gap-4">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          {/* Provider Logo */}
          <div
            className="size-10  flex items-center justify-center p-1.5"
        ...
        <button
          ...
          className="p-2  hover:bg-black/5 dark:hover:bg-white/5 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          title="Refresh quota"
        >
          <span
      ...
      {loading && (
        <div className="space-y-4">
          <div className="space-y-2">
            <div className="h-4 bg-black/5 dark:bg-white/5  animate-pulse" />
            <div className="h-2 bg-black/5 dark:bg-white/5  animate-pulse" />
          </div>
          <div className="space-y-2">
            <div className="h-4 bg-black/5 dark:bg-white/5  animate-pulse" />
            <div className="h-2 bg-black/5 dark:bg-white/5  animate-pulse" />
