...
const hasPolyRouterConfig = (settings) => Boolean(settings?.model?.base_url);
...
export async function DELETE() {
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "polyrouter model slots removed from Grok Build",
    });
  } catch (error) {
