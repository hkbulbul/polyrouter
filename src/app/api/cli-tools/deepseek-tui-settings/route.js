...
const PROVIDER_NAME = "polyrouter";
...
// Build TOML config for PolyRouter (openai provider mode)
const buildPolyRouterConfig = (baseUrl, apiKey, model) => {
...
// Detect PolyRouter by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildPolyRouterConfig(baseUrl, apiKey || "sk_polyrouter", model);
