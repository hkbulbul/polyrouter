...
// and break recursive loops between polyrouter instances connected to each other.
...
export async function buildModelsList(kindFilter, options = {}) {
  ...
  // polyrouter instance's fetchCompatibleModelIds — skip dynamic fetch to break
