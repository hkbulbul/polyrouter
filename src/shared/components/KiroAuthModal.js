        ...
        {!selectedMethod && (
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full p-4 text-left border border-border  hover:bg-sidebar transition-colors"
            >
            ...
            <button
              ...
              className="hidden w-full p-4 text-left border border-border  hover:bg-sidebar transition-colors"
            >
              <div className="flex items-start gap-3">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="min-h-40 w-full  border border-border bg-background p-3 font-mono text-sm outline-none focus:border-primary"
              />
            </div>
